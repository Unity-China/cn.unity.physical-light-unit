...
namespace UnityEngine.Rendering.Universal
{
    ...
    class LightUtils
    {
        ...
        /// <returns></returns>
        public static float ConvertPunctualLightCandelaToLumen(LightType lightType, float candela, bool enableSpotReflector, float spotAngle, float aspectRatio)
        {
            if (lightType == LightType.Spot && enableSpotReflector)
            {
        ...
        /// <param name="distance"></param>
        /// <returns></returns>
        public static float ConvertPunctualLightLuxToLumen(LightType lightType, float lux, bool enableSpotReflector, float spotAngle, float aspectRatio, float distance)
        {
            float candela = ConvertLuxToCandela(lux, distance);
            return ConvertPunctualLightCandelaToLumen(lightType, candela, enableSpotReflector, spotAngle, aspectRatio);
        }
        ...
        /// <param name="aspectRatio"></param>
        /// <returns></returns>
        public static float ConvertPunctualLightEvToLumen(LightType lightType, float ev, bool enableSpotReflector, float spotAngle, float aspectRatio)
        {
        ...
        /// <param name="height"></param>
        /// <returns></returns>
        public static float ConvertAreaLightLumenToLuminance(LightType areaLightShape, float lumen, float width, float height = 0)
        {
        ...
        /// <param name="height"></param>
        /// <returns></returns>
        public static float ConvertAreaLightLuminanceToLumen(LightType areaLightShape, float luminance, float width, float height = 0)
        {
            switch (areaLightShape)
            {
        ...
        /// <param name="height"></param>
        /// <returns></returns>
        public static float ConvertAreaLightLumenToEv(LightType AreaLightShape, float lumen, float width, float height)
        {
        ...
        /// <param name="height"></param>
        /// <returns></returns>
        public static float ConvertAreaLightEvToLumen(LightType AreaLightShape, float ev, float width, float height)
        {
        ...
        internal static void ConvertLightIntensity(LightUnit oldLightUnit, LightUnit newLightUnit, AdditionalLightData hdLight, Light light)
        {
            float intensity = hdLight.intensity;
            float luxAtDistance = hdLight.luxAtDistance;
            LightType lightType = hdLight.legacyLight.type;//hdLight.ComputeLightType(light);
            ...
            if (lightType != LightType.Area)
            {
                ...
                // Candela ->
                    ...
                    intensity = LightUtils.ConvertPunctualLightCandelaToLumen(lightType, intensity, hdLight.enableSpotReflector, light.spotAngle, hdLight.aspectRatio);
                ...
                // Lux ->
                    ...
                    intensity = LightUtils.ConvertPunctualLightLuxToLumen(lightType, intensity, hdLight.enableSpotReflector, light.spotAngle, hdLight.aspectRatio, hdLight.luxAtDistance);
                ...
                // EV100 ->
                    ...
                    intensity = LightUtils.ConvertPunctualLightEvToLumen(lightType, intensity, hdLight.enableSpotReflector, light.spotAngle, hdLight.aspectRatio);
            ...
            else  // For area lights
            {
                if (oldLightUnit == LightUnit.Lumen && newLightUnit == LightUnit.Nits)
                    intensity = LightUtils.ConvertAreaLightLumenToLuminance(lightType, intensity, hdLight.legacyLight.areaSize.x, hdLight.legacyLight.areaSize.y);
                if (oldLightUnit == LightUnit.Nits && newLightUnit == LightUnit.Lumen)
                    intensity = LightUtils.ConvertAreaLightLuminanceToLumen(lightType, intensity, hdLight.legacyLight.areaSize.x, hdLight.legacyLight.areaSize.y);
                ...
                if (oldLightUnit == LightUnit.Ev100 && newLightUnit == LightUnit.Lumen)
                    intensity = LightUtils.ConvertAreaLightEvToLumen(lightType, intensity, hdLight.legacyLight.areaSize.x, hdLight.legacyLight.areaSize.y);
        ...
        internal static Color EvaluateLightColor(Light light, AdditionalLightData hdLight)
        {
