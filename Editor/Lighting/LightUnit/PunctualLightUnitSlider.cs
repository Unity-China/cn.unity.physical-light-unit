...
namespace UnityEditor.Rendering.Universal
{
    ...
    class PunctualLightUnitSlider : PiecewiseLightUnitSlider
    {
        ...
        float UnitToLumen(float value)
        {
            ...
            return URPLightUI.ConvertLightIntensity(m_Unit, LightUnit.Lumen, m_Light, m_Editor, value);
        }
        ...
        float LumenToUnit(float value)
        {
            ...
            value = URPLightUI.ConvertLightIntensity(LightUnit.Lumen, m_Unit, m_Light, m_Editor, value);
